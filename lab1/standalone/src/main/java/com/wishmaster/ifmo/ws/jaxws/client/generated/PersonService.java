 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://jaxws.ws.ifmo.wishmaster.com/", wsdlLocation = "http://localhost:8081/jaxws/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://jaxws.ws.ifmo.wishmaster.com/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/jaxws/PersonService?wsdl");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://jaxws.ws.ifmo.wishmaster.com/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.ws.ifmo.wishmaster.com/", "PersonWebServicePort"), PersonWebService.class, features);
    }
