 ...
 * 
 */
@WebServiceClient(name = "StudentService", targetNamespace = "http://jaxws.ws.ifmo.wishmaster.com/", wsdlLocation = "http://localhost:8080/jaxws/StudentService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICE_QNAME = new QName("http://jaxws.ws.ifmo.wishmaster.com/", "StudentService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jaxws/StudentService?wsdl");
    ...
    public StudentWebService getStudentWebServicePort() {
        return super.getPort(new QName("http://jaxws.ws.ifmo.wishmaster.com/", "StudentWebServicePort"), StudentWebService.class);
    }
    ...
    public StudentWebService getStudentWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.ws.ifmo.wishmaster.com/", "StudentWebServicePort"), StudentWebService.class, features);
    }
