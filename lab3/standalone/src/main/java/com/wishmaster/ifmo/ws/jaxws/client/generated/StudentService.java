 ...
 * 
 */
@WebServiceClient(name = "StudentService", targetNamespace = "http://jaxws.ws.ifmo.wishmaster.com/", wsdlLocation = "http://localhost:8081/jaxws/StudentService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/jaxws/StudentService?wsdl");
