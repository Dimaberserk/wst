...
public class StudentWebService {
    ...
    public Integer create(@WebParam(name = "entity") Student entity) throws IllegalRequestException, InternalException {
        ...
        try {
            StudentsDAO dao = new StudentsDAO(ConnectionUtil.getConnection());
    ...
    public List<Student> searchStudents(@WebParam(name = "filter") StudentsFilter filter) throws InternalException {
        try {
            StudentsDAO dao = new StudentsDAO(ConnectionUtil.getConnection());
